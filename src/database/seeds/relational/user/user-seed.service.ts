  ...
  async run() {
    const seedUsers = [
      ...
      },
      {
        ...
        firstName: 'Quản lý',
        lastName: 'Kho Hưng Yên',
        email: 'lyquangthai1993+4@gmail.com',
        legacyUsernames: ['warehouse', 'warehouse_han', 'warehouse_hyn'],
        legacyEmails: [
          ...
          'warehouse_hyn@spiderexpress.vn',
          'lyquangthai1993+warehouse_hyn@gmail.com',
        ],
      ...
      },
      {
        ...
        legacyUsernames: ['warehouse_sgn', 'warehouse_hcm'],
        legacyEmails: [
          'warehouse_sgn@spiderexpress.vn',
          'lyquangthai1993+warehouse_sgn@gmail.com',
          'warehouse_hcm@spiderexpress.vn',
          'lyquangthai1993+warehouse_hcm@gmail.com',
        ],
        roleId: RoleEnum.WAREHOUSE_MANAGER,
        roleName: 'Warehouse Manager',
        hubCode: 'HUB-HCM-01',
